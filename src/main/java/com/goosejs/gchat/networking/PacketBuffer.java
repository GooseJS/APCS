...
public class PacketBuffer extends ByteBuf
{
    ...
    {
        return this.checkSizeByte(this.readableBytes());
    }

    public byte[] checkSizeByte(int size)
    {
    ...
    {
        return this.checkSizeInt(this.readableBytes());
    }

    public int[] checkSizeInt(int size)
    {
        int i = this.readVarIntFromBuffer();
    ...
    {
        return this.checkSizeLong(array, this.readableBytes() / 8);
    }

    public long[] checkSizeLong(long[] data, int size)
    {
        int i = this.readVarIntFromBuffer();
...
//    {
//        return Vector4f.fromFloat(this.readLong());
//    }
//
//    public PacketBuffer writeVector4f(Vector4f vector)
//    {
//        this.writeFloat(vector.toFloat());
//        return this;
//    }
    ...
    {
        int stringLength = this.readVarIntFromBuffer();
        ...
        {
            String s = new String(this.readBytes(stringLength).array(), Charsets.UTF_8);
