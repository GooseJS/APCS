package com.goosejs.gchat.renderer.glRendering;
...
public class VertexFormatElement
{
    ...
    public VertexFormatElement(int index, VertexFormatElement.EnumType type, VertexFormatElement.EnumUsage usage, int elementCount)
    {
        this.usage = usage;
        this.type = type;
        this.index = index;
